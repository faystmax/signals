package lab2.wav;// Wav file IO class
// A.Greensted
...
public class WavFile {
    ...
    public static WavFile openWavFile(File file) throws IOException, WavFileException {
        ...
        if (bytesRead != 12) throw new WavFileException("Not enough lab2.wav file bytes for header");
        ...
        while (true) {
            ...
            if (chunkID == FMT_CHUNK_ID) {
                ...
                // Check that the chunkSize (lab2.wav data length) is a multiple of the
    ...
    public static void main(String[] args) {
        ...
        try {
            for (String filename : args) {
                ...
                WavFile writeWavFile = newWavFile(new File("out.lab2.wav"), numChannels, numFrames, validBits, sampleRate);
...
//				long[] buffer = new long[BUF_SIZE * numChannels];
            ...
            WavFile writeWavFile = newWavFile(new File("out2.lab2.wav"), 1, 10, 23, 44100);
