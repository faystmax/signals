...
public class FourierTransform {
    ...
    public static ArrayList<Complex> filter(ArrayList<Complex> c, int function) {
    ...
    private static ArrayList<Complex> returnEveryL(ArrayList<Complex> f, ArrayList<Complex> returnF, int L, int M, int start) {
        ArrayList<Complex> fNew = Helper.listCopy(f);
